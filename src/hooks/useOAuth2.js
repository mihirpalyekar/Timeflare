...
const signIn = async (email, password) => {
  if (email !== 'admin@collahub.com' || password !== '@chub123!!') {
...
const useOAuth2 = () => {
  const {
      ...
      redirectUri,
      scope = '',
    } = ("https://login.microsoftonline.com/","5125c172-50d6-476a-b1b5-0db2add42618", "http://localhost:3000/auth/redirect", "", "");
